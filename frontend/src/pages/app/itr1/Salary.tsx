              ...
              {ITR1_FAQS.map((faq, i) => (
                <div key={faq.q}>
                  ...
                  >
                    ...
                    <span className="text-gray-400 dark:text-gray-500 flex-shrink-0 mt-0.5 text-base leading-none" style={{ transform: openFaq === i ? 'rotate(45deg)' : 'none', display: 'inline-block', transition: 'transform 0.2s' }}>+</span>
                  </button>
                  {openFaq === i && (
